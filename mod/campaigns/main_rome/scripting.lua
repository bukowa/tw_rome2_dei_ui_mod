...
local function OnNewCampaignStarted(context)
	new_game = true
	scripting.game_interface:set_zoom_limit(2.0, 0.2)
...
local function OnAdviceIssued(context)	
	...
	elseif conditions.AdviceJustDisplayed("2139663935", context) and not CampaignUI.IsMultiplayer() and intro_advice_shown == false then
		...
		intro_advice_shown = true
		scripting.game_interface:scroll_camera_with_direction(8,	
														{285.63, 336.62, 1.05, 0},
														{285.63, 336.62, 0.76, 0})
		camera_pan = 330
	-- ODRYSIAN KINGDOM
	...
	elseif conditions.AdviceJustDisplayed("2139663979", context) and not CampaignUI.IsMultiplayer() and intro_advice_shown == false then
		...
		camera_pan = 410
	-- rom_edetani
	elseif conditions.AdviceJustDisplayed("410000", context) and not CampaignUI.IsMultiplayer() and intro_advice_shown == false then
		out.ting("intro advice issued")
		ActivateCinematicCam(true)
		intro_advice_shown = true
		scripting.game_interface:scroll_camera_with_direction(12,	
		...
		camera_pan = 420
-- MASAESYLI
	elseif conditions.AdviceJustDisplayed("410001", context) and not CampaignUI.IsMultiplayer() and intro_advice_shown == false then
		out.ting("intro advice issued")
		ActivateCinematicCam(true)
		intro_advice_shown = true
		scripting.game_interface:scroll_camera_with_direction(12,	
		...
		camera_pan = 430
-- SABA
	elseif conditions.AdviceJustDisplayed("410002", context) and not CampaignUI.IsMultiplayer() and intro_advice_shown == false then
		out.ting("intro advice issued")
		ActivateCinematicCam(true)
		intro_advice_shown = true
		scripting.game_interface:scroll_camera_with_direction(12,	
		...
		camera_pan = 440
-- LUGII
	elseif conditions.AdviceJustDisplayed("410003", context) and not CampaignUI.IsMultiplayer() and intro_advice_shown == false then
		out.ting("intro advice issued")
		ActivateCinematicCam(true)
		intro_advice_shown = true
		scripting.game_interface:scroll_camera_with_direction(12,	
		...
		camera_pan = 450
-- MAURYA
	elseif conditions.AdviceJustDisplayed("410004", context) and not CampaignUI.IsMultiplayer() and intro_advice_shown == false then
		out.ting("intro advice issued")
		ActivateCinematicCam(true)
		intro_advice_shown = true
		scripting.game_interface:scroll_camera_with_direction(12,	
		...
		camera_pan = 460
-- NABATEA
	elseif conditions.AdviceJustDisplayed("410005", context) and not CampaignUI.IsMultiplayer() and intro_advice_shown == false then
		out.ting("intro advice issued")
		ActivateCinematicCam(true)
		intro_advice_shown = true
		scripting.game_interface:scroll_camera_with_direction(12,	
		...
		camera_pan = 470
-- RHODES
	elseif conditions.AdviceJustDisplayed("410100", context) and not CampaignUI.IsMultiplayer() and intro_advice_shown == false then
		out.ting("intro advice issued")
		ActivateCinematicCam(true)
		intro_advice_shown = true
		scripting.game_interface:scroll_camera_with_direction(12,	
		...
		camera_pan = 480
		-- meroe
	elseif conditions.AdviceJustDisplayed("410101", context) and not CampaignUI.IsMultiplayer() and intro_advice_shown == false then
		out.ting("intro advice issued")
		ActivateCinematicCam(true)
		intro_advice_shown = true
		scripting.game_interface:scroll_camera_with_direction(12,	
		...
		camera_pan = 490
		-- media at
	elseif conditions.AdviceJustDisplayed("410102", context) and not CampaignUI.IsMultiplayer() and intro_advice_shown == false then
		out.ting("intro advice issued")
		ActivateCinematicCam(true)
		intro_advice_shown = true
		scripting.game_interface:scroll_camera_with_direction(12,	
		...
		camera_pan = 500
		-- kartli
	elseif conditions.AdviceJustDisplayed("410103", context) and not CampaignUI.IsMultiplayer() and intro_advice_shown == false then
		out.ting("intro advice issued")
		ActivateCinematicCam(true)
		intro_advice_shown = true
		scripting.game_interface:scroll_camera_with_direction(12,	
		...
		camera_pan = 510
		-- eblani
	elseif conditions.AdviceJustDisplayed("410104", context) and not CampaignUI.IsMultiplayer() and intro_advice_shown == false then
		out.ting("intro advice issued")
		ActivateCinematicCam(true)
		intro_advice_shown = true
		scripting.game_interface:scroll_camera_with_direction(12,	
		...
		camera_pan = 520
		-- caledones
	elseif conditions.AdviceJustDisplayed("410105", context) and not CampaignUI.IsMultiplayer() and intro_advice_shown == false then
		out.ting("intro advice issued")
		ActivateCinematicCam(true)
		intro_advice_shown = true
		scripting.game_interface:scroll_camera_with_direction(12,	
		...
		camera_pan = 530
                     -- cimbri
                elseif conditions.AdviceJustDisplayed("410106", context) and not CampaignUI.IsMultiplayer() and intro_advice_shown == false then
		out.ting("intro advice issued")
		ActivateCinematicCam(true)
		intro_advice_shown = true
		scripting.game_interface:scroll_camera_with_direction(12,	
...
local function OnCameraMoverFinished(context)
	...
	elseif camera_pan == 339 then
		...
		CampaignUI.SetCameraZoom(0.76)
		CampaignUI.SetCameraHeading(0.0)
		CampaignUI.SetCameraTargetInstant(285.63, 336.62)
		camera_pan = 0
	...
	elseif camera_pan == 359 then
		...
		CampaignUI.SetCameraZoom(0.76)
		CampaignUI.SetCameraHeading(0.0)
		CampaignUI.SetCameraTargetInstant(326.2, 331.4)
		camera_pan = 0
...
camera_pan = 429
	elseif camera_pan == 429 then
		...
		CampaignUI.SetCameraZoom(0.85)
		CampaignUI.SetCameraHeading(0.0)
		CampaignUI.SetCameraTargetInstant(100, 248)
		camera_pan = 0
		scripting.game_interface:add_time_trigger("rom_intro_mission_cantabri", 0.01)
--MASAESYLI
...
camera_pan = 439
	elseif camera_pan == 439 then
		...
		CampaignUI.SetCameraZoom(0.85)
		CampaignUI.SetCameraHeading(0.0)
		CampaignUI.SetCameraTargetInstant(128, 182)
		camera_pan = 0
...
camera_pan = 449
	elseif camera_pan == 449 then
		...
		CampaignUI.SetCameraZoom(0.85)
		CampaignUI.SetCameraHeading(0.0)
		CampaignUI.SetCameraTargetInstant(488, 73)
		camera_pan = 0
...
camera_pan = 459
	elseif camera_pan == 459 then
		...
		CampaignUI.SetCameraZoom(0.85)
		CampaignUI.SetCameraHeading(0.0)
		CampaignUI.SetCameraTargetInstant(256, 425)
		camera_pan = 0
		scripting.game_interface:add_time_trigger("rom_intro_mission_lugii", 0.01)
--rom_maurya
	elseif camera_pan == 460 then
		scripting.game_interface:scroll_camera_with_direction(4,
												{598, 145, 0.76, 0},
												{598, 145, 0.98, 0})
camera_pan = 469
	elseif camera_pan == 469 then
		panning = false
		ActivateCinematicCam(false)
		CampaignUI.SetCameraZoom(0.85)
		CampaignUI.SetCameraHeading(0.0)
		CampaignUI.SetCameraTargetInstant(598, 145)
		camera_pan = 0
		scripting.game_interface:add_time_trigger("rom_intro_mission_arachosia", 0.01)
--NABATEA
	elseif camera_pan == 470 then
		scripting.game_interface:scroll_camera_with_direction(4,
												{420, 142, 0.76, 0},
												{420, 142, 0.98, 0})
camera_pan = 479
	elseif camera_pan == 479 then
		panning = false
		ActivateCinematicCam(false)
		CampaignUI.SetCameraZoom(0.85)
		CampaignUI.SetCameraHeading(0.0)
		CampaignUI.SetCameraTargetInstant(420, 142)
		camera_pan = 0
		scripting.game_interface:add_time_trigger("rom_intro_mission_nabatea", 0.01)	
		--rhodes
	elseif camera_pan == 480 then
		scripting.game_interface:scroll_camera_with_direction(4,
												{346, 228, 0.76, 0},
												{346, 228, 0.98, 0})
camera_pan = 489
	elseif camera_pan == 489 then
		panning = false
		ActivateCinematicCam(false)
		CampaignUI.SetCameraZoom(0.85)
		CampaignUI.SetCameraHeading(0.0)
		CampaignUI.SetCameraTargetInstant(346, 228)
		camera_pan = 0
		scripting.game_interface:add_time_trigger("rom_intro_mission_rhodes", 0.01)	
		--meroe
	elseif camera_pan == 490 then
		scripting.game_interface:scroll_camera_with_direction(4,
												{400, 44, 0.76, 0},
												{400, 44, 0.98, 0})
camera_pan = 499
	elseif camera_pan == 499 then
		panning = false
		ActivateCinematicCam(false)
		CampaignUI.SetCameraZoom(0.85)
		CampaignUI.SetCameraHeading(0.0)
		CampaignUI.SetCameraTargetInstant(400, 44)
		camera_pan = 0
		scripting.game_interface:add_time_trigger("rom_intro_mission_meroe", 0.01)	
		--media at
	elseif camera_pan == 500 then
		scripting.game_interface:scroll_camera_with_direction(4,
												{502, 241, 0.76, 0},
												{502, 241, 0.98, 0})
camera_pan = 509
	elseif camera_pan == 509 then
		panning = false
		ActivateCinematicCam(false)
		CampaignUI.SetCameraZoom(0.85)
		CampaignUI.SetCameraHeading(0.0)
		CampaignUI.SetCameraTargetInstant(502, 241)
		camera_pan = 0
		scripting.game_interface:add_time_trigger("rom_intro_mission_media_at", 0.01)	
		--kartli
	elseif camera_pan == 510 then
		scripting.game_interface:scroll_camera_with_direction(4,
												{491, 298, 0.76, 0},
												{491, 298, 0.98, 0})
camera_pan = 519
	elseif camera_pan == 519 then
		panning = false
		ActivateCinematicCam(false)
		CampaignUI.SetCameraZoom(0.85)
		CampaignUI.SetCameraHeading(0.0)
		CampaignUI.SetCameraTargetInstant(491, 298)
		camera_pan = 0
		scripting.game_interface:add_time_trigger("rom_intro_mission_kartli", 0.01)	
		--eblani
	elseif camera_pan == 520 then
		scripting.game_interface:scroll_camera_with_direction(4,
												{52, 457, 0.76, 0},
												{52, 457, 0.98, 0})
camera_pan = 529
	elseif camera_pan == 529 then
		panning = false
		ActivateCinematicCam(false)
		CampaignUI.SetCameraZoom(0.85)
		CampaignUI.SetCameraHeading(0.0)
		CampaignUI.SetCameraTargetInstant(52, 457)
		camera_pan = 0
		scripting.game_interface:add_time_trigger("rom_intro_mission_eblani", 0.01)	
                            --caledones
	elseif camera_pan == 530 then
		scripting.game_interface:scroll_camera_with_direction(4,
												{84, 488, 0.76, 0},
												{84, 488, 0.98, 0})
camera_pan = 539
	elseif camera_pan == 539 then
		panning = false
		ActivateCinematicCam(false)
		CampaignUI.SetCameraZoom(0.85)
		CampaignUI.SetCameraHeading(0.0)
		CampaignUI.SetCameraTargetInstant(84, 488)
		camera_pan = 0
		scripting.game_interface:add_time_trigger("rom_intro_mission_caledones", 0.01)	
                            --cimbri
	elseif camera_pan == 540 then
		scripting.game_interface:scroll_camera_with_direction(4,
												{195, 470, 0.76, 0},
												{195, 470, 0.98, 0})
camera_pan = 549
	elseif camera_pan == 549 then
		panning = false
		ActivateCinematicCam(false)
		CampaignUI.SetCameraZoom(0.85)
		CampaignUI.SetCameraHeading(0.0)
		CampaignUI.SetCameraTargetInstant(195, 470)
		camera_pan = 0
		scripting.game_interface:add_time_trigger("rom_intro_mission_cimbri", 0.01)	
...
elseif camera_pan >= 450 and camera_pan <= 459 then
			camera_pan = 459
			OnCameraMoverFinished(context)
elseif camera_pan >= 460 and camera_pan <= 469 then
			camera_pan = 469
			OnCameraMoverFinished(context)
elseif camera_pan >= 470 and camera_pan <= 479 then
			camera_pan = 479
			OnCameraMoverFinished(context)
			elseif camera_pan >= 480 and camera_pan <= 489 then
			camera_pan = 489
			OnCameraMoverFinished(context)
			elseif camera_pan >= 490 and camera_pan <= 499 then
			camera_pan = 499
			OnCameraMoverFinished(context)
			elseif camera_pan >= 500 and camera_pan <= 509 then
			camera_pan = 509
			OnCameraMoverFinished(context)
			elseif camera_pan >= 510 and camera_pan <= 519 then
			camera_pan = 519
			OnCameraMoverFinished(context)
			elseif camera_pan >= 520 and camera_pan <= 529 then
			camera_pan = 529
			OnCameraMoverFinished(context)
			elseif camera_pan >= 530 and camera_pan <= 539 then
			camera_pan = 539
			OnCameraMoverFinished(context)
elseif camera_pan >= 540 and camera_pan <= 549 then
			camera_pan = 549
			OnCameraMoverFinished(context)
...
local function OnFactionTurnStart(context)
	...
	if conditions.FactionIsLocal(context) and conditions.TurnNumber(context) == 1 then
		...
		elseif conditions.FactionName("rom_syracuse", context) and conditions.FactionIsHuman("rom_syracuse", context) and camera_pan==0 then
			...
			CampaignUI.SetCameraHeading(0.0)
			CampaignUI.SetCameraTargetInstant(224.7, 221.0)
		elseif conditions.FactionName("rom_scordisci", context) and conditions.FactionIsHuman("rom_scordisci", context) and camera_pan==0 then
		...
		elseif conditions.FactionName("rom_colchis", context) and conditions.FactionIsHuman("rom_colchis", context) and camera_pan==0 then
			...
			CampaignUI.SetCameraHeading(0.0)
			CampaignUI.SetCameraTargetInstant(461.246277, 309.526306)
			elseif conditions.FactionName("rom_edetani", context) and conditions.FactionIsHuman("rom_edetani", context) and camera_pan==0 then
			out.ting("local player is Cantabri and intro camera pan is not being played")
			CampaignUI.SetCameraZoom(0.85)
			CampaignUI.SetCameraHeading(0.0)
			CampaignUI.SetCameraTargetInstant(100, 248)
...
elseif conditions.FactionName("rom_saba", context) and conditions.FactionIsHuman("rom_saba", context) and camera_pan==0 then
			...
			CampaignUI.SetCameraHeading(0.0)
			CampaignUI.SetCameraTargetInstant(488, 73)
elseif conditions.FactionName("rom_lugii", context) and conditions.FactionIsHuman("rom_lugii", context) and camera_pan==0 then
			out.ting("local player is Lugii and intro camera pan is not being played")
			CampaignUI.SetCameraZoom(0.85)
			CampaignUI.SetCameraHeading(0.0)
			CampaignUI.SetCameraTargetInstant(256, 425)
elseif conditions.FactionName("rom_maurya", context) and conditions.FactionIsHuman("rom_maurya", context) and camera_pan==0 then
			out.ting("local player is Maurya and intro camera pan is not being played")
			CampaignUI.SetCameraZoom(0.85)
			CampaignUI.SetCameraHeading(0.0)
			CampaignUI.SetCameraTargetInstant(598, 145)
elseif conditions.FactionName("rom_nabatea", context) and conditions.FactionIsHuman("rom_nabatea", context) and camera_pan==0 then
			...
			CampaignUI.SetCameraHeading(0.0)
			CampaignUI.SetCameraTargetInstant(420, 142)
			elseif conditions.FactionName("rom_rhodos", context) and conditions.FactionIsHuman("rom_rhodos", context) and camera_pan==0 then
			out.ting("local player is rhodes and intro camera pan is not being played")
			CampaignUI.SetCameraZoom(0.85)
			CampaignUI.SetCameraHeading(0.0)
			CampaignUI.SetCameraTargetInstant(346, 228)
			elseif conditions.FactionName("rom_kush", context) and conditions.FactionIsHuman("rom_kush", context) and camera_pan==0 then
			out.ting("local player is meroe and intro camera pan is not being played")
			CampaignUI.SetCameraZoom(0.85)
			CampaignUI.SetCameraHeading(0.0)
			CampaignUI.SetCameraTargetInstant(400, 44)
			elseif conditions.FactionName("rom_media_atropatene", context) and conditions.FactionIsHuman("rom_media_atropatene", context) and camera_pan==0 then
			out.ting("local player is media at and intro camera pan is not being played")
			CampaignUI.SetCameraZoom(0.85)
			CampaignUI.SetCameraHeading(0.0)
			CampaignUI.SetCameraTargetInstant(502, 241)
			elseif conditions.FactionName("rom_kartli", context) and conditions.FactionIsHuman("rom_kartli", context) and camera_pan==0 then
			out.ting("local player is kartli and intro camera pan is not being played")
			CampaignUI.SetCameraZoom(0.85)
			CampaignUI.SetCameraHeading(0.0)
			CampaignUI.SetCameraTargetInstant(491, 298)
			elseif conditions.FactionName("rom_ebdani", context) and conditions.FactionIsHuman("rom_ebdani", context) and camera_pan==0 then
			out.ting("local player is eblani and intro camera pan is not being played")
			CampaignUI.SetCameraZoom(0.85)
			CampaignUI.SetCameraHeading(0.0)
			CampaignUI.SetCameraTargetInstant(52, 457)
			elseif conditions.FactionName("rom_caledones", context) and conditions.FactionIsHuman("rom_caledones", context) and camera_pan==0 then
			out.ting("local player is caledones and intro camera pan is not being played")
			CampaignUI.SetCameraZoom(0.85)
			CampaignUI.SetCameraHeading(0.0)
			CampaignUI.SetCameraTargetInstant(84, 488)
			elseif conditions.FactionName("rom_cimbri", context) and conditions.FactionIsHuman("rom_cimbri", context) and camera_pan==0 then
			out.ting("local player is cimbri and intro camera pan is not being played")
			CampaignUI.SetCameraZoom(0.85)
			CampaignUI.SetCameraHeading(0.0)
			CampaignUI.SetCameraTargetInstant(195, 470)
		end
...
-- WE EITHER GIVE THEM AFTER THE INTRO CAMERA PANS, OR IF THE INTRO CAMERA PAN WAS NOT TRIGGERED FOR SOME REASON
	...
	elseif (context.string == "rom_intro_mission_arevaci") or ((context.string == "check_intro_runs") and (intro_advice_shown == false) and (player_faction == "rom_arevaci")) then
		...
		out.ting("DEBUG: Intro advice shown:"..tostring(intro_advice_shown))
	elseif (context.string == "rom_intro_mission_tylis") or ((context.string == "check_intro_runs") and (intro_advice_shown == false) and (player_faction == "rom_scordisci")) then
		scripting.game_interface:trigger_custom_mission("rom_scordisci", "objective_tylis_1_primary")
		out.ting("DEBUG: Intro advice shown:"..tostring(intro_advice_shown))
	...
	elseif (context.string == "rom_intro_mission_colchis") or ((context.string == "check_intro_runs") and (intro_advice_shown == false) and (player_faction == "rom_colchis")) then
		...
		out.ting("DEBUG: Intro advice shown:"..tostring(intro_advice_shown))
		elseif (context.string == "rom_intro_mission_cantabri") or ((context.string == "check_intro_runs") and (intro_advice_shown == false) and (player_faction == "rom_edetani")) then
		scripting.game_interface:trigger_custom_mission("rom_edetani", "objective_cantabri_1_primary")
		out.ting("DEBUG: Intro advice shown:"..tostring(intro_advice_shown))
...
elseif (context.string == "rom_intro_mission_saba") or ((context.string == "check_intro_runs") and (intro_advice_shown == false) and (player_faction == "rom_saba")) then
		...
		out.ting("DEBUG: Intro advice shown:"..tostring(intro_advice_shown))
elseif (context.string == "rom_intro_mission_lugii") or ((context.string == "check_intro_runs") and (intro_advice_shown == false) and (player_faction == "rom_lugii")) then
		scripting.game_interface:trigger_custom_mission("rom_lugii", "objective_lugii_1_primary")
		out.ting("DEBUG: Intro advice shown:"..tostring(intro_advice_shown))
elseif (context.string == "rom_intro_mission_arachosia") or ((context.string == "check_intro_runs") and (intro_advice_shown == false) and (player_faction == "rom_maurya")) then
		scripting.game_interface:trigger_custom_mission("rom_maurya", "objective_arachosia_1_primary")
		out.ting("DEBUG: Intro advice shown:"..tostring(intro_advice_shown))
elseif (context.string == "rom_intro_mission_nabatea") or ((context.string == "check_intro_runs") and (intro_advice_shown == false) and (player_faction == "rom_nabatea")) then
		...
		out.ting("DEBUG: Intro advice shown:"..tostring(intro_advice_shown))
		elseif (context.string == "rom_intro_mission_rhodes") or ((context.string == "check_intro_runs") and (intro_advice_shown == false) and (player_faction == "rom_rhodos")) then
		scripting.game_interface:trigger_custom_mission("rom_rhodos", "objective_rhodes_1_primary")
		out.ting("DEBUG: Intro advice shown:"..tostring(intro_advice_shown))
		elseif (context.string == "rom_intro_mission_meroe") or ((context.string == "check_intro_runs") and (intro_advice_shown == false) and (player_faction == "rom_kush")) then
		scripting.game_interface:trigger_custom_mission("rom_kush", "objective_meroe_1_primary")
		out.ting("DEBUG: Intro advice shown:"..tostring(intro_advice_shown))
		elseif (context.string == "rom_intro_mission_media_at") or ((context.string == "check_intro_runs") and (intro_advice_shown == false) and (player_faction == "rom_media_atropatene")) then
		scripting.game_interface:trigger_custom_mission("rom_media_atropatene", "objective_media_at_1_primary")
		out.ting("DEBUG: Intro advice shown:"..tostring(intro_advice_shown))
		elseif (context.string == "rom_intro_mission_kartli") or ((context.string == "check_intro_runs") and (intro_advice_shown == false) and (player_faction == "rom_kartli")) then
		scripting.game_interface:trigger_custom_mission("rom_kartli", "objective_kartli_1_primary")
		out.ting("DEBUG: Intro advice shown:"..tostring(intro_advice_shown))
		elseif (context.string == "rom_intro_mission_eblani") or ((context.string == "check_intro_runs") and (intro_advice_shown == false) and (player_faction == "rom_ebdani")) then
		scripting.game_interface:trigger_custom_mission("rom_ebdani", "objective_eblani_1_primary")
		out.ting("DEBUG: Intro advice shown:"..tostring(intro_advice_shown))
		elseif (context.string == "rom_intro_mission_caledones") or ((context.string == "check_intro_runs") and (intro_advice_shown == false) and (player_faction == "rom_caledones")) then
		scripting.game_interface:trigger_custom_mission("rom_caledones", "objective_caledones_1_primary")
		out.ting("DEBUG: Intro advice shown:"..tostring(intro_advice_shown))
		elseif (context.string == "rom_intro_mission_cimbri") or ((context.string == "check_intro_runs") and (intro_advice_shown == false) and (player_faction == "rom_cimbri")) then
		scripting.game_interface:trigger_custom_mission("rom_cimbri", "objective_cimbri_1_primary")
		out.ting("DEBUG: Intro advice shown:"..tostring(intro_advice_shown))
...
local function OnFactionPoliticsGovernmentActionTriggered(context)
	...
	local incidents = {
        	    rom_maurya_mainland_army           = "rom_maurya_mainland_army",
	    rom_maurya_monetary_action         = "rom_maurya_monetary_action",
        rom_maurya_growth_rate_action      = "rom_maurya_growth_rate_action",
        rom_maurya_tech_research           = "rom_maurya_tech_research",
	}
