...
function OccupationDecisionAvailableForFaction(faction, occupation_decision)
	...
	if (faction_culture == "rom_Barbarian") or (faction_culture == "rom_Roman") or (faction_sub_culture == "sc_rom_carthaginian") or (faction_sub_culture == "sc_rom_african_arabian") or (faction_name == "inv_taranto") or (faction_name == "rom_syracuse_alex") or (faction_name == "rom_massilia_alex") then
...
local changeCapital = require "lua_scripts.changeCapitalAlex";
local auto_resolve  = require "lua_scripts.auto_resolve_bonus";
local Alexander  = require "lua_scripts.Alexander";
