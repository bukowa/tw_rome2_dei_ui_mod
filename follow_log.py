...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1:
        ...
        file_paths = [
            r"C:\Program Files (x86)\Steam\steamapps\common\Total War Rome II\event_list_table_logging.txt",
            r"C:\Program Files (x86)\Steam\steamapps\common\Total War Rome II\transfer_settlement.log",
        ]
